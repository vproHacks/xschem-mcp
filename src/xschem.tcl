...
#
# MCP automation wrappers
# -----------------------
# These wrappers provide a stable, validated surface for external automation
# clients (MCP bridge / Gemini CLI integrations) and return normalized JSON payloads.
#
namespace eval mcp {
